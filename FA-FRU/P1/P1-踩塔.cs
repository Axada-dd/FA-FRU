...
public class P1_踩塔 : ITriggerScript
{
    private List<KeyValuePair<string, Vector3>> 踩塔 = [];
    public bool Check(ScriptEnv scriptEnv, ITriggerCondParams condParams)
    {
        if (!scriptEnv.KV.ContainsKey("P1塔雷")&& !scriptEnv.KV.ContainsKey("P1塔")) return false;
        ...
        if (lei)//雷
        {
            ...
            踩塔.Add(new ("MT", new ((100f + (eastTower ? -10.5f : 10.5f)), 0f, 94.5f)));
            踩塔.Add(new ("ST", new ((100f + (eastTower ? -10.5f : 10.5f)), 0f, 105.5f)));
